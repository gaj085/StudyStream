...
function ProcessingPipeline({ status, progress, message }) {
  ...
  const stages = [
    {
      ...
      desc: "Getting the available captions from YouTube",
      minProgress: 20,
      icon: FileText,
    },
    {
      ...
      desc: "Breaking the lecture into timestamped sections",
      minProgress: 40,
      icon: Scissors,
    },
    {
      id: "embedding",
      name: "Prepare search",
      desc: "Making each section easy to find later",
      minProgress: 60,
      icon: Cpu,
    },
    {
      id: "indexing",
      name: "Save sources",
      desc: "Storing the lecture sections and their timestamps",
      minProgress: 80,
      icon: Database,
    },
    {
      ...
      desc: "Pulling together a summary, key ideas, and quiz",
      minProgress: 90,
      icon: BookOpen,
    },
  ];
  ...
  const getStageStatus = (stage, currentStatus, currentProgress) => {
    ...
    if (currentProgress >= stage.minProgress + 10) {
      ...
      currentProgress < stage.minProgress + 10
    ) {
      return "active";
    }
    ...
    <div className="max-w-xl mx-auto py-8 px-4 animate-fade-in">
      <div className="glass-panel p-8 rounded-2xl border border-slate-800/80 shadow-2xl relative overflow-hidden">
        <div className="text-center mb-8">
          <h3 className="text-xl font-bold mb-2">Preparing your lecture</h3>
          ...
          {stages.map((stage, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`z-10 flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300 ${
